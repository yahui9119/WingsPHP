...
THREE.Quaternion.prototype = {constructor: THREE.Quaternion, set: function (a, b, c, d) {
    ...
    var c = Math.cos(a.x / 2), d = Math.cos(a.y / 2), e = Math.cos(a.z / 2), f = Math.sin(a.x / 2), g = Math.sin(a.y / 2), i = Math.sin(a.z / 2);
    ...
    var b = a.elements, c = b[0], a = b[4], d = b[8], e = b[1], f = b[5], g = b[9], i = b[2], h = b[6], b = b[10], k = c + f + b;
    ...
    var c = a.x, d = a.y, e = a.z, f = a.w, g = b.x, i = b.y, h = b.z, k = b.w;
    ...
    var i = Math.acos(g), h = Math.sqrt(1 - g * g);
...
THREE.Vector3.prototype = {constructor: THREE.Vector3, set: function (a, b, c) {
    ...
    var b = this.x, c = this.y, d = this.z, e = a.x, f = a.y, g = a.z, a = a.w, i = a * b + f * d - g * c, h = a * c + g * b - e * d, k = a * d + e * c - f * b, b = -e * b - f * c - g * d;
    ...
    var d = a.elements,
        e = d[0], f = d[4], g = d[8], i = d[1], h = d[5], k = d[9], l = d[2], m = d[6], d = d[10];
    ...
    var b = this.set(a.elements[0],
        a.elements[1], a.elements[2]).length(), c = this.set(a.elements[4], a.elements[5], a.elements[6]).length(), a = this.set(a.elements[8], a.elements[9], a.elements[10]).length();
    this.x = b;
    this.y = c;
    this.z = a;
    return this
...
THREE.Box2.prototype = {constructor: THREE.Box2, set: function (a, b) {
    ...
    return THREE.Box2.__v1.copy(a).clamp(this.min, this.max).sub(a).length()
...
THREE.Box3.prototype = {constructor: THREE.Box3, set: function (a, b) {
    ...
    b || new THREE.Vector3;
    return(new THREE.Vector3).copy(a).clamp(this.min, this.max)
}, distanceToPoint: function (a) {
    return THREE.Box3.__v1.copy(a).clamp(this.min,
    ...
    a = [THREE.Box3.__v0.set(this.min.x, this.min.y, this.min.z).applyMatrix4(a), THREE.Box3.__v0.set(this.min.x, this.min.y, this.min.z).applyMatrix4(a), THREE.Box3.__v1.set(this.min.x,
        this.min.y, this.max.z).applyMatrix4(a), THREE.Box3.__v2.set(this.min.x, this.max.y, this.min.z).applyMatrix4(a), THREE.Box3.__v3.set(this.min.x, this.max.y, this.max.z).applyMatrix4(a), THREE.Box3.__v4.set(this.max.x, this.min.y, this.min.z).applyMatrix4(a), THREE.Box3.__v5.set(this.max.x, this.min.y, this.max.z).applyMatrix4(a), THREE.Box3.__v6.set(this.max.x, this.max.y, this.min.z).applyMatrix4(a), THREE.Box3.__v7.set(this.max.x, this.max.y, this.max.z).applyMatrix4(a)];
    this.makeEmpty();
...
THREE.Matrix3.prototype = {constructor: THREE.Matrix3, set: function (a, b, c, d, e, f, g, i, h) {
    var k = this.elements;
    k[0] = a;
    k[3] = b;
    k[6] = c;
    ...
    multiplyVector3Array: function (a) {
        ...
        var a = this.elements, b = a[0], c = a[1], d = a[2], e = a[3], f = a[4], g = a[5], i = a[6], h = a[7], a = a[8];
...
THREE.Matrix4.prototype = {constructor: THREE.Matrix4, set: function (a, b, c, d, e, f, g, i, h, k, l, m, n, r, p, q) {
    var s = this.elements;
    s[0] = a;
    s[4] = b;
    s[8] = c;
    ...
    var c =
        this.elements, d = a.x, e = a.y, f = a.z, g = Math.cos(d), d = Math.sin(d), i = Math.cos(e), e = Math.sin(e), h = Math.cos(f), f = Math.sin(f);
    if (void 0 === b || "XYZ" === b) {
        var k = g * h, l = g * f, m = d * h, n = d * f;
        c[0] = i * h;
        c[4] = -i * f;
        c[8] = e;
        c[1] = l + m * e;
    ...
    var b = this.elements, c = a.x, d = a.y, e = a.z, f = a.w, g = c + c, i = d + d, h = e +
        e, a = c * g, k = c * i, c = c * h, l = d * i, d = d * h, e = e * h, g = f * g, i = f * i, f = f * h;
    b[0] = 1 - (l + e);
    b[4] = k - f;
    b[8] = c + i;
    b[1] = k + f;
    ...
    var c = a.elements, d = b.elements, e = this.elements, f = c[0], g = c[4], i = c[8], h = c[12], k = c[1], l = c[5], m = c[9], n = c[13], r = c[2], p = c[6], q = c[10], s = c[14], t = c[3], x = c[7], z = c[11], c = c[15], v = d[0], I = d[4], H = d[8], D = d[12], y = d[1], F = d[5], E = d[9], G = d[13],
        W = d[2], A = d[6], X = d[10], B = d[14], K = d[3], L = d[7], U = d[11], d = d[15];
    e[0] = f * v + g * y + i * W + h * K;
    e[4] = f * I + g * F + i * A + h * L;
    e[8] = f * H + g * E + i * X + h * U;
    ...
    var a = this.elements, b = a[0], c = a[4], d = a[8], e = a[12], f = a[1], g = a[5], i = a[9], h = a[13], k = a[2], l = a[6], m = a[10], n = a[14];
    ...
    var c = this.elements, d = a.elements, e = d[0], f = d[4], g = d[8], i = d[12], h = d[1], k = d[5], l = d[9], m = d[13], n = d[2], r = d[6], p = d[10], q = d[14], s = d[3], t = d[7], x = d[11], z = d[15];
    ...
    var b = this.elements, c = b[4], d = b[5], e = b[6], f = b[7], g = b[8], i = b[9], h = b[10], k = b[11], l = Math.cos(a), a = Math.sin(a);
    b[4] = l * c + a * g;
    b[5] = l * d + a * i;
    b[6] = l * e + a * h;
    b[7] = l *
    ...
    var b = this.elements, c = b[0], d = b[1], e = b[2], f = b[3], g = b[8], i = b[9], h = b[10], k = b[11], l = Math.cos(a), a = Math.sin(a);
    b[0] = l * c - a * g;
    b[1] = l * d - a * i;
    b[2] = l * e - a * h;
    b[3] = l * f - a * k;
    ...
    var b = this.elements, c = b[0], d = b[1], e = b[2], f = b[3], g = b[4], i = b[5], h = b[6], k = b[7], l = Math.cos(a), a = Math.sin(a);
    b[0] = l * c + a * g;
    b[1] = l * d + a * i;
    b[2] = l * e + a * h;
    b[3] = l * f + a * k;
    ...
    var d = a.x, e = a.y, f = a.z, g = Math.sqrt(d * d + e * e + f * f), d = d / g, e = e / g, f = f / g, g = d * d, i = e * e, h = f * f, k = Math.cos(b), l = Math.sin(b), m = 1 - k, n = d * e * m, r = d * f * m, m = e * f * m, d = d * l, p = e * l, l = f * l, f = g + (1 - g) * k, g = n + l, e = r - p, n = n - l, i = i + (1 - i) * k, l = m + d, r = r + p, m = m - d, h = h + (1 - h) * k, k = c[0], d =
        c[1], p = c[2], q = c[3], s = c[4], t = c[5], x = c[6], z = c[7], v = c[8], I = c[9], H = c[10], D = c[11];
    c[0] = f * k + g * s + e * v;
    c[1] = f * d + g * t + e * I;
    c[2] = f * p + g * x + e * H;
    c[3] = f * q + g * z + e * D;
    ...
    var c = Math.cos(b), d = Math.sin(b), e = 1 - c, f = a.x, g = a.y, i = a.z, h = e * f, k = e * g;
    ...
    var g = this.elements, i = b - a, h = c - d, k = f - e;
    g[0] = 2 / i;
    g[4] = 0;
    g[8] = 0;
    g[12] = -((b + a) / i);
...
THREE.Ray.prototype = {constructor: THREE.Ray, set: function (a, b) {
    ...
    var b = THREE.Ray.__v1.subVectors(a, this.origin).dot(this.direction);
    THREE.Ray.__v1.copy(this.direction).multiplyScalar(b).add(this.origin);
...
THREE.Frustum.prototype = {set: function (a, b, c, d, e, f) {
    var g = this.planes;
    g[0].copy(a);
    g[1].copy(b);
    g[2].copy(c);
    ...
    var b = this.planes, c = a.elements, a = c[0], d = c[1], e = c[2], f = c[3], g = c[4], i = c[5], h = c[6], k = c[7], l = c[8], m = c[9], n = c[10], r = c[11], p = c[12], q = c[13], s = c[14], c = c[15];
    b[0].setComponents(f - a, k - g, r - l, c - p).normalize();
    b[1].setComponents(f + a, k + g, r + l,
        c + p).normalize();
    b[2].setComponents(f + d, k + i, r + m, c + q).normalize();
    b[3].setComponents(f - d, k - i, r - m, c - q).normalize();
    b[4].setComponents(f - e, k - h, r - n, c - s).normalize();
    b[5].setComponents(f + e, k + h, r + n, c + s).normalize();
    return this
}, intersectsObject: function (a) {
    for (var b = a.matrixWorld, c = this.planes, d = b.getPosition(), a = -a.geometry.boundingSphere.radius * b.getMaxScaleOnAxis(), b = 0; 6 > b; b++)if (c[b].distanceToPoint(d) < a)return!1;
    return!0
}, intersectsSphere: function (a) {
    for (var b = this.planes, c = a.center, a = -a.radius, d =
        0; 6 > d; d++)if (b[d].distanceToPoint(c) < a)return!1;
    return!0
}, containsPoint: function (a) {
...
THREE.Plane.prototype = {constructor: THREE.Plane, set: function (a, b) {
    ...
    b = THREE.Plane.__v1.subVectors(c, b).cross(THREE.Plane.__v2.subVectors(a, b)).normalize();
    ...
    return(b ||
        new THREE.Vector3).copy(this.normal).multiplyScalar(c)
    ...
    var c = c || new THREE.Vector3, b = THREE.Plane.__v1.subVectors(b, a), d = this.normal.dot(b);
    if (0 == d) {
        if (0 == this.distanceToPoint(a))return c.copy(a)
    } else return d = -(a.dot(this.normal) + this.constant) / d, 0 > d || 1 < d ? void 0 : c.copy(b).multiplyScalar(d).add(a)
}, coplanarPoint: function (a) {
    return(a || new THREE.Vector3).copy(this.normal).multiplyScalar(-this.constant)
},
    transform: function (a, b) {
        var b = b || (new THREE.Matrix3).getInverse(a).transpose(), c = THREE.Plane.__v1.copy(this.normal).applyMatrix3(b), d = this.coplanarPoint(THREE.Plane.__v2);
        d.applyMatrix4(a);
...
THREE.Spline = function (a) {
    ...
    this.points = a;
    var c = [], d = {x: 0, y: 0, z: 0}, e, f, g, i, h, k, l, m, n;
    ...
    this.getLength = function (a) {
        var b, c, d, e = b = b = 0, f = new THREE.Vector3, g = new THREE.Vector3, i = [], h = 0;
        i[0] = 0;
        a || (a = 100);
        ...
        i[i.length] = h;
        return{chunks: i, total: h}
    };
    this.reparametrizeByArcLength = function (a) {
        var b, c, d, e, f, g, i = [], h = new THREE.Vector3, k = this.getLength();
        i.push(h.copy(this.points[0]).clone());
        for (b = 1; b < this.points.length; b++) {
            ...
            for (c = 1; c < g - 1; c++)d = e + c * (1 / g) * (f - e), d = this.getPoint(d),
                i.push(h.copy(d).clone());
            i.push(h.copy(this.points[b]).clone())
        }
        this.points = i
    }
};
...
THREE.Triangle.prototype = {constructor: THREE.Triangle, set: function (a, b, c) {
    ...
    return 0.5 * THREE.Triangle.__v0.cross(THREE.Triangle.__v1).length()
}, midpoint: function (a) {
    return(a ||
...
(function (a) {
    ...
    var b = new a.Sphere, c = new a.Ray, d = new a.Plane, e = new a.Vector3, f = new a.Matrix4, g = function (a, b) {
        return a.distance - b.distance
    }, i = function (g, i, h) {
        if (g instanceof a.Particle) {
            i = i.ray.distanceToPoint(g.matrixWorld.getPosition());
            if (i > g.scale.x)return h;
            h.push({distance: i, point: g.position, face: null, object: g})
            ...
            var n = g.geometry, r = n.vertices, p = g.material instanceof a.MeshFaceMaterial, q = !0 === p ? g.material.materials : null, s = g.material.side, t, x, z, v = i.precision;
            g.matrixRotationWorld.extractRotation(g.matrixWorld);
            f.getInverse(g.matrixWorld);
            c.copy(i.ray).transform(f);
            for (var I = 0, H = n.faces.length; I < H; I++) {
                var D = n.faces[I], s = !0 === p ? q[D.materialIndex] : g.material;
                if (void 0 !== s) {
                    ...
                    if (!(Math.abs(y) < v) && !(0 > y)) {
                        ...
                        if (!(y < i.near || y > i.far)) {
                            ...
                            h.push({distance: y,
                                point: i.ray.at(y), face: D, faceIndex: I, object: g})
                        }
                    }
                }
            }
...
THREE.Projector = function () {
    ...
    function d(a, b) {
        var c = 0, d = 1, e = a.z + a.w, f = b.z + b.w, g = -a.z + a.w, i = -b.z + b.w;
    ...
    this.projectScene = function (g, i, m, Ja) {
        var ma = !1, wa, Ta, Ra, ia, ra, ga, Z, pa, gb, hb, Ea, yb, Cb;
        y = v = s = r = 0;
        G.elements.length = 0;
        g.updateMatrixWorld();
        ...
        var Lb = function (b) {
            for (var c = 0, d = b.children.length; c < d; c++) {
                ...
                if (!1 !== f.visible) {
                    if (f instanceof
                        THREE.Light)G.lights.push(f); else if (f instanceof THREE.Mesh || f instanceof THREE.Line) {
        ...
        g = 0;
        for (m = G.objects.length; g < m; g++)if (pa = G.objects[g].object, ba = pa.matrixWorld, k = 0, pa instanceof THREE.Mesh) {
            gb = pa.geometry;
            Ra = gb.vertices;
            hb = gb.faces;
            gb = gb.faceVertexUvs;
            ...
            wa = 0;
            for (Ta = Ra.length; wa < Ta; wa++)h = b(), h.positionWorld.copy(Ra[wa]).applyMatrix4(ba),
                h.positionScreen.copy(h.positionWorld).applyMatrix4(aa), h.positionScreen.x /= h.positionScreen.w, h.positionScreen.y /= h.positionScreen.w, h.positionScreen.z /= h.positionScreen.w, h.visible = !(-1 > h.positionScreen.x || 1 < h.positionScreen.x || -1 > h.positionScreen.y || 1 < h.positionScreen.y || -1 > h.positionScreen.z || 1 < h.positionScreen.z);
            Ra = 0;
            for (wa = hb.length; Ra < wa; Ra++) {
                ...
                if (void 0 !== Ua) {
                    ga = Ua.side;
                    if (Ta instanceof THREE.Face3)if (ia = l[Ta.a], ra = l[Ta.b],
                    ...
                    n.normalModel.applyMatrix3(J).normalize();
                    n.normalModelView.copy(n.normalModel).applyMatrix3(ha);
                    n.centroidModel.copy(Ta.centroid).applyMatrix4(ba);
                    Z = Ta.vertexNormals;
                    ia = 0;
                    for (ra = Z.length; ia < ra; ia++)Ea = n.vertexNormalsModel[ia], Ea.copy(Z[ia]), !1 === ma && (ga === THREE.BackSide || ga === THREE.DoubleSide) && Ea.negate(), Ea.applyMatrix3(J).normalize(), n.vertexNormalsModelView[ia].copy(Ea).applyMatrix3(ha);
                    n.vertexNormalsLength = Z.length;
                    ia = 0;
                    for (ra = gb.length; ia < ra; ia++)if (Ea = gb[ia][Ra], void 0 !== Ea) {
                        ga = 0;
                    ...
                    n.color =
                        Ta.color;
                    n.material = Ua;
                    ua.copy(n.centroidModel).applyProjection(aa);
                    n.z = ua.z;
                    G.elements.push(n)
                }
            }
            ...
            ia = b();
            ia.positionScreen.copy(Ra[0]).applyMatrix4(xa);
            hb = pa.type === THREE.LinePieces ? 2 : 1;
            wa = 1;
            for (Ta = Ra.length; wa < Ta; wa++)ia = b(), ia.positionScreen.copy(Ra[wa]).applyMatrix4(xa), 0 < (wa + 1) % hb || (ra = l[k - 2], M.copy(ia.positionScreen), fa.copy(ra.positionScreen), !0 === d(M, fa) && (M.multiplyScalar(1 / M.w), fa.multiplyScalar(1 / fa.w),
...
THREE.Geometry.prototype = {constructor: THREE.Geometry, applyMatrix: function (a) {
    ...
    var a, b, c, d, e, f, g = new THREE.Vector3, i = new THREE.Vector3;
    a = 0;
    ...
    if (a) {
        var f, g, i, h = new THREE.Vector3, k = new THREE.Vector3, l = new THREE.Vector3, m = new THREE.Vector3, n = new THREE.Vector3;
        b = 0;
    ...
    for (b = this.morphTargets.length; a < b; a++) {
        if (!this.morphNormals[a]) {
            ...
            var g = this.morphNormals[a].faceNormals, i = this.morphNormals[a].vertexNormals, h, k;
            c = 0;
            for (d = this.faces.length; c < d; c++)e = this.faces[c], h = new THREE.Vector3, k = e instanceof THREE.Face3 ? {a: new THREE.Vector3, b: new THREE.Vector3, c: new THREE.Vector3} : {a: new THREE.Vector3, b: new THREE.Vector3, c: new THREE.Vector3, d: new THREE.Vector3}, g.push(h), i.push(k)
        }
    ...
    var b, c, d, e, f, g, i, h, k, l, m, n, r, p, q, s, t, x, z, v, I, H, D, y, F = [], E = [], G = new THREE.Vector3, W = new THREE.Vector3, A = new THREE.Vector3, X = new THREE.Vector3, B = new THREE.Vector3;
    b = 0;
    ...
    for (c = this.faces.length; b < c; b++) {
        f = this.faces[b];
        for (d = 0; d < f.vertexNormals.length; d++)B.copy(f.vertexNormals[d]), e = f[K[d]], y = F[e], A.copy(y), A.sub(B.multiplyScalar(B.dot(y))).normalize(),
    ...
    var a = {}, b = [], c = [], d, e = Math.pow(10, 4), f, g, i, h, k;
...
THREE.BufferGeometry.prototype = {constructor: THREE.BufferGeometry, applyMatrix: function (a) {
    ...
    if (this.attributes.position) {
        ...
        if (void 0 === this.attributes.normal)this.attributes.normal = {itemSize: 3, array: new Float32Array(a), numItems: a}; else {
            a = 0;
            for (b = this.attributes.normal.array.length; a < b; a++)this.attributes.normal.array[a] =
                0
        }
        var e = this.attributes.position.array, f = this.attributes.normal.array, g, i, h, k, l, m, n = new THREE.Vector3, r = new THREE.Vector3, p = new THREE.Vector3, q = new THREE.Vector3, s = new THREE.Vector3;
        if (this.attributes.index) {
            var t = this.attributes.index.array, x = this.offsets;
            c = 0;
    ...
    function a(a) {
        ...
        ha = h[a];
        U.copy(ha);
        U.sub(ba.multiplyScalar(ba.dot(ha))).normalize();
    ...
    if (void 0 === this.attributes.index || void 0 === this.attributes.position ||
        ...
        var l, m, n, r, p, q, s, t, x, z, v, I, H, D, y, f = new THREE.Vector3, g = new THREE.Vector3, F, E, G, W, A, X, B, K = this.offsets;
        G = 0;
        ...
        var U = new THREE.Vector3, aa = new THREE.Vector3, ba = new THREE.Vector3, xa = new THREE.Vector3, J, ha, ua;
        G = 0;
        for (W = K.length; G < W; ++G) {
            E = K[G].start;
            A = K[G].count;
...
THREE.Loader.prototype = {constructor: THREE.Loader, crossOrigin: "anonymous", addStatusElement: function () {
    ...
    function e(a, e, f, i, h, k, s) {
        var t = f.toLowerCase().endsWith(".dds"), x = b + "/" + f;
        if (t) {
        ...
        k && (f = {repeat: THREE.RepeatWrapping, mirror: THREE.MirroredRepeatWrapping},
            void 0 !== f[k[0]] && (a[e].wrapS = f[k[0]]), void 0 !== f[k[1]] && (a[e].wrapT = f[k[1]]));
        s && (a[e].anisotropy = s);
        if (!t) {
            var v = a[e], a = new Image;
            a.onload = function () {
                if (!c(this.width) || !c(this.height)) {
                    var a = d(this.width), b = d(this.height);
                    v.image.width = a;
                    v.image.height = b;
                    v.image.getContext("2d").drawImage(this, 0, 0, a, b)
                } else v.image = this;
                v.needsUpdate = !0
            };
    ...
    var g = this, i = "MeshLambertMaterial", h = {color: 15658734, opacity: 1,
        map: null, lightMap: null, normalMap: null, bumpMap: null, wireframe: !1};
    if (a.shading) {
...
THREE.JSONLoader.prototype.createModel = function (a, b, c) {
    var d = new THREE.Geometry, e = void 0 !== a.scale ? 1 / a.scale : 1, f, g, i, h, k, l, m, n, r, p, q, s, t, x, z, v = a.faces;
    p = a.vertices;
    var I = a.normals, H = a.colors, D = 0;
    ...
    for (k = v.length; h < k;) {
        ...
        i = d.faces.length;
        if (f)for (f = 0; f < D; f++)t = a.uvs[f], r = v[h++], z = t[2 * r], r = t[2 * r + 1], d.faceUvs[f][i] = new THREE.Vector2(z, r);
        if (g)for (f = 0; f < D; f++) {
            t = a.uvs[f];
            x = [];
...
THREE.SceneLoader.prototype.parse = function (a, b, c) {
    ...
    function f(a, b) {
        var c, e, g, h, k, m, q;
        for (q in b)if (void 0 === y.objects[q]) {
            var s = b[q], v = null;
            if (s.type && s.type in l.hierarchyHandlerMap) {
                if (void 0 === s.loading) {
                    e = {type: 1, url: 1, material: 1, position: 1, rotation: 1, scale: 1, visible: 1, children: 1, properties: 1, skin: 1, morph: 1, mirroredLoop: 1, duration: 1};
                    g = {};
                ...
                if (n = y.geometries[s.geometry]) {
                    ...
                    if (r instanceof THREE.MeshFaceMaterial)for (e = 0; e < r.materials.length; e++)v = v || r.materials[e]instanceof THREE.ShaderMaterial;
                    v && n.computeTangents();
            ...
            if (v) {
                if (void 0 !==
                    s.properties)for (var D in s.properties)v.properties[D] = s.properties[D];
                if (void 0 !== s.groups)for (e = 0; e < s.groups.length; e++)g = s.groups[e], void 0 === y.groups[g] && (y.groups[g] = []), y.groups[g].push(q);
    ...
    function i(a, b, c, d) {
        return function (f) {
            var f = f.content ? f.content : f.dae ? f.scene : f, g = d.position, i = d.rotation, h = d.quaternion, n = d.scale;
    ...
    function k() {
        l.callbackProgress({totalModels: H, totalTextures: D, loadedModels: H - v, loadedTextures: D - I}, y);
        l.onLoadProgress();
        if (0 ===
            v && 0 === I) {
            for (var a = 0; a < F.length; a++) {
                var c = F[a], d = y.objects[c.targetName];
    ...
    var l = this, m = THREE.Loader.prototype.extractUrlBase(c), n, r, p, q, s, t, x, z, v, I, H, D, y, F = [], E = a, G;
    ...
    H = v;
    for (A in E.geometries)if (q = E.geometries[A], "cube" === q.type)n = new THREE.CubeGeometry(q.width, q.height, q.depth,
        ...
        q.segmentsT), y.geometries[A] = n; else if ("icosahedron" === q.type)n = new THREE.IcosahedronGeometry(q.radius, q.subdivisions), y.geometries[A] = n; else if (q.type in this.geometryHandlerMap) {
        X = {};
    ...
    for (var B in E.textures)if (A = E.textures[B], A.url instanceof
        Array) {
        I += A.url.length;
    ...
    for (B in E.textures) {
        ...
        if (A.url instanceof Array) {
        ...
        } else s = A.url.toLowerCase().endsWith(".dds"), X = d(A.url,
            ...
            mirror: THREE.MirroredRepeatWrapping}, void 0 !== X[A.wrap[0]] && (s.wrapS = X[A.wrap[0]]), void 0 !== X[A.wrap[1]] && (s.wrapT = X[A.wrap[1]]));
        y.textures[B] = s
    }
    var K, L;
...
THREE.CanvasRenderer = function (a) {
    ...
    var a = a || {}, f = this, g, i, h, k = new THREE.Projector, l = void 0 !== a.canvas ? a.canvas :
        ...
        new THREE.Color, Mb = new THREE.Color, ib = new THREE.Vector3, zb, Ob, rc, ob, Fa, sb, pb = 16;
    ...
    this.render = function (a, l) {
        function n(a, b, c) {
            for (var d = 0, e = h.length; d < e; d++) {
                ...
                if (f instanceof THREE.DirectionalLight) {
                    var g = f.matrixWorld.getPosition().normalize(), j = b.dot(g);
                    0 >= j || (j *= f.intensity, c.add(Ta.multiplyScalar(j)))
                } else f instanceof THREE.PointLight && (g = f.matrixWorld.getPosition(), j = b.dot(ib.subVectors(g, a).normalize()),
        ...
        function m(a, d, e, g, j, i, h, Y) {
            ...
            (Y instanceof THREE.MeshLambertMaterial || Y instanceof THREE.MeshPhongMaterial) && null === Y.map && null === Y.map ? (ma.copy(Y.color), wa.copy(Y.emissive),
                ...
                Y.wireframeLinecap, Y.wireframeLinejoin) : x(fa)) : Y.shading == THREE.SmoothShading && (d = h.vertexNormalsModelView[g], Da.setRGB(d.x, d.y, d.z).multiplyScalar(0.5).addScalar(0.5), d = h.vertexNormalsModelView[j], Aa.setRGB(d.x, d.y, d.z).multiplyScalar(0.5).addScalar(0.5), d = h.vertexNormalsModelView[i], Ia.setRGB(d.x, d.y, d.z).multiplyScalar(0.5).addScalar(0.5), Ja.addColors(Aa, Ia).multiplyScalar(0.5), Z = jb(Da, Aa, Ia, Ja), I(B, K, L, U, aa, ba, 0, 0, 1, 0, 0, 1, Z)))
        }
        ...
        function z(a, b, c, d, f, g, j, i, h, Y, k, l, n) {
            if (!(n instanceof THREE.DataTexture || void 0 === n.image || 0 == n.image.width)) {
                if (!0 === n.needsUpdate) {
                    var m = n.wrapS == THREE.RepeatWrapping, p = n.wrapT ==
        ...
        if (!1 === l instanceof THREE.Camera)console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera."); else {
            ...
            for (Nb = i.length; pb < Nb; pb++) {
                ...
                if (!(void 0 === S || !1 === S.visible)) {
                    ...
                    if (ja instanceof THREE.RenderableParticle) {
                        ...
                        b(S.opacity);
                        c(S.blending);
                        var Va = void 0, $a = void 0, Wa = void 0, Pa = void 0, Y = ja = void 0, dd = void 0;
...
THREE.WebGLRenderer = function (a) {
    ...
    function d(a, b) {
        var c = b.geometry, d = a.faces3, i = a.faces4, h = 3 * d.length + 4 * i.length, k = 1 * d.length + 2 * i.length, i = 3 * d.length + 4 * i.length, d = e(b, a), n = g(d), l = f(d), m = d.vertexColors ? d.vertexColors : !1;
    ...
    function h(a, b, c) {
        var d = a.attributes, e = d.index, f = d.position, g = d.normal, i = d.uv, h = d.color, d = d.tangent;
    ...
    function r(a, b, c) {
        if (a.length)for (var d = 0, e = a.length; d < e; d++)wa =
    ...
    function p(a, b, c, d, e, f, g, j) {
        ...
        for (var l = h; l !== b; l += n)if (i = a[l], i.render) {
            h = i.object;
            k = i.buffer;
            if (j)i = j; else {
                i = i[c];
    ...
    function q(a, b, c, d, e, f, g) {
        for (var j, i, h = 0, k = a.length; h < k; h++)if (j = a[h], i = j.object, i.visible) {
            if (g)j = g; else {
                j = j[b];
                if (!j)continue;
        ...
        if (f) {
            ...
            if (d instanceof THREE.MeshPhongMaterial || d instanceof THREE.MeshLambertMaterial || d.lights) {
                if (sb) {
                    for (var n, l = k = 0, m = 0, q, p, s, r = pb, t = r.directional.colors, v = r.directional.positions, x = r.point.colors, z = r.point.positions, D = r.point.distances, B = r.spot.colors, E = r.spot.positions, G = r.spot.distances, I = r.spot.directions, J = r.spot.anglesCos, fa = r.spot.exponents, S = r.hemi.skyColors, U = r.hemi.groundColors, W = r.hemi.positions,
                        ...
                        THREE.HemisphereLight && (ba += 1, n.visible && (Fa.copy(n.matrixWorld.getPosition()), Fa.normalize(), 0 === Fa.x && 0 === Fa.y && 0 === Fa.z || (s = 3 * ia, W[s] = Fa.x, W[s + 1] = Fa.y, W[s + 2] = Fa.z, q = n.color, n = n.groundColor, M.gammaInput ? (p *= p, y(S, s, q, p), y(U, s, n, p)) : (F(S, s, q, p), F(U, s, n, p)), ia += 1))));
                    c = 3 * X;
            ...
            if (e.receiveShadow && !d._shadowPass && h.shadowMatrix) {
                ...
                for (f = b.length; c < f; c++)if (k = b[c], k.castShadow && (k instanceof
                    THREE.SpotLight || k instanceof THREE.DirectionalLight && !k.shadowCascade))h.shadowMap.value[Z] = k.shadowMap, h.shadowMapSize.value[Z] = k.shadowMapSize, h.shadowMatrix.value[Z] = k.shadowMatrix, h.shadowDarkness.value[Z] = k.shadowDarkness, h.shadowBias.value[Z] = k.shadowBias, Z++
            }
            b = d.uniformsList;
            h = 0;
            for (Z = b.length; h < Z; h++)if (f = g.uniforms[b[h][1]])if (c = b[h][0], l = c.type, k = c.value, "i" === l)j.uniform1i(f, k); else if ("f" === l)j.uniform1f(f, k); else if ("v2" === l)j.uniform2f(f, k.x, k.y); else if ("v3" === l)j.uniform3f(f, k.x,
                k.y, k.z); else if ("v4" === l)j.uniform4f(f, k.x, k.y, k.z, k.w); else if ("c" === l)j.uniform3f(f, k.r, k.g, k.b); else if ("iv1" === l)j.uniform1iv(f, k); else if ("iv" === l)j.uniform3iv(f, k); else if ("fv1" === l)j.uniform1fv(f, k); else if ("fv" === l)j.uniform3fv(f, k); else if ("v2v" === l) {
                ...
                if (r = k, k = H(), j.uniform1i(f, k), r)if (r.image instanceof Array && 6 === r.image.length) {
                    if (c = r, f = k, 6 === c.image.length)if (c.needsUpdate) {
                        ...
                        k = [];
                        for (l = 0; 6 > l; l++)M.autoScaleCubemaps && !f ? (m = k, r = l, t = c.image[l], x = ad, t.width <= x && t.height <= x || (z = Math.max(t.width, t.height), v = Math.floor(t.width * x / z), x = Math.floor(t.height * x / z), z = document.createElement("canvas"), z.width = v, z.height = x, z.getContext("2d").drawImage(t, 0, 0, t.width, t.height, 0, 0, v, x), t = z), m[r] = t) : k[l] = c.image[l];
                        l = k[0];
    ...
    this.info = {memory: {programs: 0,
        geometries: 0, textures: 0}, render: {calls: 0, vertices: 0, faces: 0, points: 0}};
    var M = this, fa = [], Da = 0, Aa = null, Ia = null, Ja = -1, ma = null, wa = null, Ta = 0, Ra = 0, ia = -1, ra = -1, ga = -1, Z = -1, pa = -1, gb = -1, hb = -1, Ea = -1, yb = null, Cb = null, Lb = null, Ua = null, na = 0, Ya = 0, Db = 0, nb = 0, kc = 0, Mb = 0, ib = {}, zb = new THREE.Frustum, Ob = new THREE.Matrix4, rc = new THREE.Matrix4, ob = new THREE.Vector3, Fa = new THREE.Vector3, sb = !0, pb = {ambient: [0, 0, 0], directional: {length: 0, colors: [], positions: []}, point: {length: 0, colors: [], positions: [], distances: []}, spot: {length: 0,
        colors: [], positions: [], distances: [], directions: [], anglesCos: [], exponents: []}, hemi: {length: 0, skyColors: [], groundColors: [], positions: []}}, j, lc, sc, Eb, Ab;
    try {
        if (!(j = L.getContext("experimental-webgl", {alpha: aa, premultipliedAlpha: ba, antialias: xa, stencil: J, preserveDrawingBuffer: ha})))throw"Error creating WebGL context.";
    } catch (bd) {
        console.error(bd)
    }
    ...
    this.context = j;
    var Bc = j.getParameter(j.MAX_TEXTURE_IMAGE_UNITS), $c = j.getParameter(j.MAX_VERTEX_TEXTURE_IMAGE_UNITS);
    ...
    var Nb = j.getShaderPrecisionFormat(j.FRAGMENT_SHADER, j.HIGH_FLOAT), S = j.getShaderPrecisionFormat(j.FRAGMENT_SHADER, j.MEDIUM_FLOAT);
    ...
    var T = 0 < kb.precision && 0 < Nb.precision, ja = 0 < cd.precision && 0 < S.precision;
    ...
    var Za = function (a) {
        ...
        if (void 0 !== b) {
            a.program = void 0;
            var c, d, e = !1, a = 0;
            for (c = fa.length; a < c; a++)if (d = fa[a], d.program === b) {
                d.usedTimes--;
                0 === d.usedTimes && (e = !0);
                break
            }
    ...
    this.renderBufferDirect = function (a, b, c, d, e, f) {
        if (!1 !== d.visible)if (c = I(a, b, c, d, f), a = c.attributes,
            b = !1, d = 16777215 * e.id + 2 * c.id + (d.wireframe ? 1 : 0), d !== ma && (ma = d, b = !0), b && l(), f instanceof THREE.Mesh)if (f = e.attributes.index) {
            d = e.offsets;
            1 < d.length && (b = !0);
            for (var c = 0, g = d.length; c < g; c++) {
                var h = d[c].index;
                if (b) {
                    var i = e.attributes.position, n = i.itemSize;
    ...
    this.renderBuffer = function (a, b, c, d, e, f) {
        if (!1 !== d.visible) {
            var g, h, c = I(a, b, c, d, f), b = c.attributes, a = !1, c = 16777215 * e.id + 2 * c.id + (d.wireframe ? 1 : 0);
            c !== ma && (ma = c, a = !0);
            a && l();
            if (!d.morphTargets &&
                0 <= b.position)a && (j.bindBuffer(j.ARRAY_BUFFER, e.__webglVertexBuffer), k(b.position), j.vertexAttribPointer(b.position, 3, j.FLOAT, !1, 0, 0)); else if (f.morphTargetBase) {
    ...
    this.render = function (a, b, c, d) {
        if (!1 === b instanceof THREE.Camera)console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera."); else {
            var e, f, g, h, i = a.__lights, k = a.fog;
            Ja = -1;
            sb = !0;
            ...
            h = a.__webglObjects;
            d = 0;
            for (e = h.length; d < e; d++)if (f = h[d], g = f.object, f.render = !1, g.visible && (!(g instanceof THREE.Mesh || g instanceof THREE.ParticleSystem) || !g.frustumCulled || zb.intersectsObject(g))) {
                D(g, b);
                var n = f, l = n.buffer, s = void 0, t = s = void 0, t = n.object.material;
                if (t instanceof THREE.MeshFaceMaterial)s =
                    l.materialIndex, s = t.materials[s], s.transparent ? (n.transparent = s, n.opaque = null) : (n.opaque = s, n.transparent = null); else if (s = t)s.transparent ? (n.transparent = s, n.opaque = null) : (n.opaque = s, n.transparent = null);
                f.render = !0;
    ...
    this.initWebGLObjects = function (a) {
        ...
        for (; a.__objectsAdded.length;) {
            var b = a.__objectsAdded[0], k = a, l = void 0, m = void 0, p = void 0, q = void 0;
            if (!b.__webglInit)if (b.__webglInit = !0, b._modelViewMatrix = new THREE.Matrix4, b._normalMatrix = new THREE.Matrix3, void 0 !== b.geometry && void 0 === b.geometry.__webglInit && (b.geometry.__webglInit = !0, b.geometry.addEventListener("dispose", Za)), b instanceof THREE.Mesh)if (m = b.geometry, p = b.material, m instanceof THREE.Geometry) {
                if (void 0 === m.geometryGroups) {
                    var r = m, y = void 0, A = void 0, D = void 0, B = void 0, F = void 0, E = void 0, G = {}, H = r.morphTargets.length, I = r.morphNormals.length, K = p instanceof THREE.MeshFaceMaterial;
                    r.geometryGroups =
                    {};
                    y = 0;
                    for (A = r.faces.length; y < A; y++)D = r.faces[y], B = K ? D.materialIndex : 0, void 0 === G[B] && (G[B] = {hash: B, counter: 0}), E = G[B].hash + "_" + G[B].counter, void 0 === r.geometryGroups[E] && (r.geometryGroups[E] = {faces3: [], faces4: [], materialIndex: B, vertices: 0, numMorphTargets: H, numMorphNormals: I}), F = D instanceof THREE.Face3 ? 3 : 4, 65535 < r.geometryGroups[E].vertices + F && (G[B].counter += 1, E = G[B].hash + "_" + G[B].counter, void 0 === r.geometryGroups[E] && (r.geometryGroups[E] = {faces3: [], faces4: [], materialIndex: B, vertices: 0, numMorphTargets: H,
                        numMorphNormals: I})), D instanceof THREE.Face3 ? r.geometryGroups[E].faces3.push(y) : r.geometryGroups[E].faces4.push(y), r.geometryGroups[E].vertices += F;
                    r.geometryGroupsList = [];
                    var L = void 0;
                    for (L in r.geometryGroups)r.geometryGroups[L].id = Ta++, r.geometryGroupsList.push(r.geometryGroups[L])
                }
                for (l in m.geometryGroups)if (q = m.geometryGroups[l], !q.__webglVertexBuffer) {
                    var J = q;
            ...
            } else m instanceof THREE.BufferGeometry && i(m); else if (b instanceof THREE.Ribbon) {
                if (m = b.geometry, !m.__webglVertexBuffer) {
                    ...
                    M.info.memory.geometries++;
                    var T = m, X = b, W = T.vertices.length;
                ...
                if (m = b.geometry, !m.__webglVertexBuffer)if (m instanceof THREE.Geometry) {
                    ...
                    M.info.memory.geometries++;
                    var aa = m, ia = b, Aa = aa.vertices.length;
                ...
                M.info.memory.geometries++;
                var Da = m, ja = b, ma = Da.vertices.length;
            ...
            if (!b.__webglActive) {
                if (b instanceof THREE.Mesh)if (m = b.geometry, m instanceof THREE.BufferGeometry)s(k.__webglObjects, m, b); else {
                    if (m instanceof THREE.Geometry)for (l in m.geometryGroups)q =
                        m.geometryGroups[l], s(k.__webglObjects, q, b)
                } else b instanceof THREE.Ribbon || b instanceof THREE.Line || b instanceof THREE.ParticleSystem ? (m = b.geometry, s(k.__webglObjects, m, b)) : b instanceof THREE.ImmediateRenderObject || b.immediateRenderCallback ? k.__webglObjectsImmediate.push({object: b, opaque: null, transparent: null}) : b instanceof THREE.Sprite ? k.__webglSprites.push(b) : b instanceof THREE.LensFlare && k.__webglFlares.push(b);
                b.__webglActive = !0
            }
        ...
        for (var Ja = 0, ra = a.__webglObjects.length; Ja < ra; Ja++) {
            var ha = a.__webglObjects[Ja].object,
                N = ha.geometry, Ra = void 0, pa = void 0, ga = void 0;
            if (ha instanceof THREE.Mesh)if (N instanceof THREE.BufferGeometry)(N.verticesNeedUpdate || N.elementsNeedUpdate || N.uvsNeedUpdate || N.normalsNeedUpdate || N.colorsNeedUpdate || N.tangentsNeedUpdate) && h(N, j.DYNAMIC_DRAW, !N.dynamic), N.verticesNeedUpdate = !1, N.elementsNeedUpdate = !1, N.uvsNeedUpdate = !1, N.normalsNeedUpdate = !1, N.colorsNeedUpdate = !1, N.tangentsNeedUpdate = !1; else {
                for (var ua = 0, Ea = N.geometryGroupsList.length; ua < Ea; ua++)if (Ra = N.geometryGroupsList[ua], ga = e(ha,
                    ...
                    var qa = Ra, Fa = ha, na = j.DYNAMIC_DRAW, Oa = !N.dynamic, xa = ga;
                    if (qa.__inittedArrays) {
                        var Ya = f(xa), gb = xa.vertexColors ? xa.vertexColors : !1, pb = g(xa), ib = Ya === THREE.SmoothShading, C = void 0, V = void 0, Va = void 0, O = void 0, $a = void 0, Wa = void 0, Pa = void 0, nb = void 0, Ua = void 0, hb = void 0, sb = void 0, P = void 0, Q = void 0,
                        ...
                        if ($c && Ya) {
                            C = 0;
                            for (V = sa.length; C < V; C++)if (O = rb[sa[C]], $a = O.vertexNormals, Wa = O.normal, 3 === $a.length && ib)for (va = 0; 3 > va; va++)mc = $a[va], Gb[qb] = mc.x, Gb[qb + 1] = mc.y, Gb[qb + 2] = mc.z, qb += 3; else for (va = 0; 3 > va; va++)Gb[qb] = Wa.x, Gb[qb + 1] = Wa.y, Gb[qb + 2] = Wa.z, qb += 3;
                            C = 0;
                            for (V = ta.length; C < V; C++)if (O = rb[ta[C]], $a = O.vertexNormals, Wa = O.normal, 4 === $a.length && ib)for (va = 0; 4 > va; va++)mc = $a[va], Gb[qb] = mc.x, Gb[qb + 1] = mc.y, Gb[qb + 2] = mc.z, qb += 3; else for (va = 0; 4 > va; va++)Gb[qb] = Wa.x, Gb[qb + 1] = Wa.y, Gb[qb +
                                2] = Wa.z, qb += 3;
                        ...
                        if (Bc && fd && pb) {
                            C = 0;
                            for (V = sa.length; C < V; C++)if (Va = sa[C], hb = fd[Va], void 0 !== hb)for (va = 0; 3 > va; va++)Eb = hb[va], Mb[gc] = Eb.x, Mb[gc + 1] = Eb.y, gc += 2;
                            C = 0;
                            for (V = ta.length; C < V; C++)if (Va = ta[C], hb = fd[Va], void 0 !== hb)for (va = 0; 4 > va; va++)Eb = hb[va], Mb[gc] = Eb.x, Mb[gc + 1] = Eb.y, gc += 2;
                            0 < gc && (j.bindBuffer(j.ARRAY_BUFFER, qa.__webglUVBuffer), j.bufferData(j.ARRAY_BUFFER, Mb, na))
                        }
                        if (Bc && gd && pb) {
                            C = 0;
                            for (V = sa.length; C < V; C++)if (Va =
                                sa[C], sb = gd[Va], void 0 !== sb)for (va = 0; 3 > va; va++)xc = sb[va], Nb[hc] = xc.x, Nb[hc + 1] = xc.y, hc += 2;
                            C = 0;
                            for (V = ta.length; C < V; C++)if (Va = ta[C], sb = gd[Va], void 0 !== sb)for (va = 0; 4 > va; va++)xc = sb[va], Nb[hc] = xc.x, Nb[hc + 1] = xc.y, hc += 2;
                        ...
                        if (ed) {
                            va = 0;
                            for (Lb = ed.length; va < Lb; va++)if (u = ed[va], u.__original.needsUpdate) {
                                w = 0;
                ...
                if (N.verticesNeedUpdate || N.colorsNeedUpdate || N.normalsNeedUpdate || pa) {
                    var Hb = N, Lc = j.DYNAMIC_DRAW, Cc = void 0, Dc = void 0, Ec = void 0, Mc = void 0, za = void 0, Nc = void 0, Oc = void 0, Pc = void 0, md = void 0, lb = void 0, yc = void 0, Ga = void 0, vb = void 0, nd = Hb.vertices, od = Hb.colors, pd = Hb.normals, yd = nd.length, zd = od.length, Ad = pd.length, Qc = Hb.__vertexArray, Rc = Hb.__colorArray, Sc = Hb.__normalArray, Bd = Hb.colorsNeedUpdate, Cd = Hb.normalsNeedUpdate, hd = Hb.__webglCustomAttributesList;
                    ...
                    if (hd) {
                        Pc =
                            0;
                        for (md = hd.length; Pc < md; Pc++)if (Ga = hd[Pc], Ga.needsUpdate && (void 0 === Ga.boundTo || "vertices" === Ga.boundTo)) {
                            za = 0;
                            yc = Ga.value.length;
                            if (1 === Ga.size)for (lb = 0; lb < yc; lb++)Ga.array[lb] = Ga.value[lb]; else if (2 === Ga.size)for (lb = 0; lb < yc; lb++)vb = Ga.value[lb], Ga.array[za] = vb.x, Ga.array[za + 1] = vb.y, za += 2; else if (3 === Ga.size)if ("c" === Ga.type)for (lb = 0; lb < yc; lb++)vb = Ga.value[lb], Ga.array[za] = vb.r, Ga.array[za + 1] = vb.g, Ga.array[za + 2] = vb.b, za += 3; else for (lb = 0; lb < yc; lb++)vb = Ga.value[lb], Ga.array[za] = vb.x, Ga.array[za + 1] =
                                vb.y, Ga.array[za + 2] = vb.z, za += 3; else if (4 === Ga.size)for (lb = 0; lb < yc; lb++)vb = Ga.value[lb], Ga.array[za] = vb.x, Ga.array[za + 1] = vb.y, Ga.array[za + 2] = vb.z, Ga.array[za + 3] = vb.w, za += 4;
                ...
                N.normalsNeedUpdate = !1;
                ga.attributes && x(ga)
            } else if (ha instanceof THREE.Line)if (N instanceof THREE.BufferGeometry)(N.verticesNeedUpdate || N.colorsNeedUpdate) && h(N, j.DYNAMIC_DRAW, !N.dynamic), N.verticesNeedUpdate = !1, N.colorsNeedUpdate = !1; else {
                ga = e(ha, N);
                pa = ga.attributes && t(ga);
                if (N.verticesNeedUpdate || N.colorsNeedUpdate || N.lineDistancesNeedUpdate || pa) {
                    var Ib = N, Tc = j.DYNAMIC_DRAW, Fc = void 0, Gc = void 0, Hc = void 0, Uc = void 0, Na = void 0, Vc = void 0, qd = Ib.vertices, rd = Ib.colors, sd = Ib.lineDistances, Dd = qd.length, Ed = rd.length, Fd = sd.length, Wc = Ib.__vertexArray, Xc = Ib.__colorArray, td = Ib.__lineDistanceArray, Gd = Ib.colorsNeedUpdate, Hd = Ib.lineDistancesNeedUpdate, id = Ib.__webglCustomAttributesList, Yc = void 0, ud = void 0, mb = void 0, zc = void 0,
                        wb = void 0, Ha = void 0;
                    ...
                    if (id) {
                        Yc = 0;
                        for (ud = id.length; Yc < ud; Yc++)if (Ha = id[Yc], Ha.needsUpdate && (void 0 === Ha.boundTo || "vertices" === Ha.boundTo)) {
                            Na = 0;
                            zc = Ha.value.length;
                            if (1 === Ha.size)for (mb = 0; mb < zc; mb++)Ha.array[mb] = Ha.value[mb]; else if (2 === Ha.size)for (mb = 0; mb < zc; mb++)wb = Ha.value[mb], Ha.array[Na] = wb.x, Ha.array[Na + 1] = wb.y, Na += 2; else if (3 === Ha.size)if ("c" === Ha.type)for (mb = 0; mb < zc; mb++)wb = Ha.value[mb], Ha.array[Na] = wb.r, Ha.array[Na + 1] = wb.g, Ha.array[Na + 2] = wb.b, Na += 3; else for (mb = 0; mb < zc; mb++)wb = Ha.value[mb], Ha.array[Na] = wb.x,
                                Ha.array[Na + 1] = wb.y, Ha.array[Na + 2] = wb.z, Na += 3; else if (4 === Ha.size)for (mb = 0; mb < zc; mb++)wb = Ha.value[mb], Ha.array[Na] = wb.x, Ha.array[Na + 1] = wb.y, Ha.array[Na + 2] = wb.z, Ha.array[Na + 3] = wb.w, Na += 4;
                ...
                ga.attributes && x(ga)
            } else if (ha instanceof THREE.ParticleSystem)if (N instanceof THREE.BufferGeometry)(N.verticesNeedUpdate || N.colorsNeedUpdate) && h(N, j.DYNAMIC_DRAW,
                !N.dynamic), N.verticesNeedUpdate = !1, N.colorsNeedUpdate = !1; else {
                ga = e(ha, N);
                pa = ga.attributes && t(ga);
                if (N.verticesNeedUpdate || N.colorsNeedUpdate || ha.sortParticles || pa) {
                    var bc = N, jd = j.DYNAMIC_DRAW, Ic = ha, xb = void 0, cc = void 0, dc = void 0, ea = void 0, ec = void 0, qc = void 0, Zc = bc.vertices, kd = Zc.length, ld = bc.colors, vd = ld.length, vc = bc.__vertexArray, wc = bc.__colorArray, ic = bc.__sortArray, wd = bc.verticesNeedUpdate, xd = bc.colorsNeedUpdate, jc = bc.__webglCustomAttributesList, Jb = void 0, Ac = void 0, la = void 0, Kb = void 0, Ca = void 0,
                        da = void 0;
                    if (Ic.sortParticles) {
                        rc.copy(Ob);
                        ...
                        if (jc) {
                            Jb = 0;
                            for (Ac = jc.length; Jb < Ac; Jb++)if (da = jc[Jb], void 0 === da.boundTo || "vertices" === da.boundTo)if (ea = 0, Kb = da.value.length, 1 === da.size)for (la = 0; la < Kb; la++)ec = ic[la][1],
                        ...
                        if (wd)for (xb = 0; xb < kd; xb++)dc = Zc[xb], ea = 3 * xb, vc[ea] = dc.x, vc[ea + 1] = dc.y, vc[ea + 2] = dc.z;
                        if (xd)for (cc = 0; cc < vd; cc++)qc = ld[cc], ea = 3 * cc, wc[ea] = qc.r, wc[ea + 1] = qc.g, wc[ea + 2] = qc.b;
                        if (jc) {
                            Jb = 0;
                            for (Ac = jc.length; Jb < Ac; Jb++)if (da = jc[Jb], da.needsUpdate && (void 0 === da.boundTo || "vertices" === da.boundTo))if (Kb = da.value.length, ea = 0, 1 === da.size)for (la = 0; la < Kb; la++)da.array[la] = da.value[la]; else if (2 === da.size)for (la = 0; la < Kb; la++)Ca = da.value[la], da.array[ea] = Ca.x,
                                da.array[ea + 1] = Ca.y, ea += 2; else if (3 === da.size)if ("c" === da.type)for (la = 0; la < Kb; la++)Ca = da.value[la], da.array[ea] = Ca.r, da.array[ea + 1] = Ca.g, da.array[ea + 2] = Ca.b, ea += 3; else for (la = 0; la < Kb; la++)Ca = da.value[la], da.array[ea] = Ca.x, da.array[ea + 1] = Ca.y, da.array[ea + 2] = Ca.z, ea += 3; else if (4 === da.size)for (la = 0; la < Kb; la++)Ca = da.value[la], da.array[ea] = Ca.x, da.array[ea + 1] = Ca.y, da.array[ea + 2] = Ca.z, da.array[ea + 3] = Ca.w, ea += 4
                        }
                    }
                    ...
                    if (jc) {
                        Jb = 0;
                        for (Ac = jc.length; Jb < Ac; Jb++)if (da = jc[Jb], da.needsUpdate || Ic.sortParticles)j.bindBuffer(j.ARRAY_BUFFER, da.buffer), j.bufferData(j.ARRAY_BUFFER, da.array, jd)
                    }
                }
                N.verticesNeedUpdate = !1;
                N.colorsNeedUpdate = !1;
    ...
    this.initMaterial = function (a, b, c, d) {
        ...
        a:{
            ...
            b = a.attributes;
            r = a.defines;
            var c = {map: !!a.map, envMap: !!a.envMap, lightMap: !!a.lightMap, bumpMap: !!a.bumpMap, normalMap: !!a.normalMap, specularMap: !!a.specularMap, vertexColors: a.vertexColors, fog: c, useFog: a.fog, fogExp: c instanceof THREE.FogExp2, sizeAttenuation: a.sizeAttenuation,
                ...
                alphaTest: a.alphaTest, metal: a.metal, perPixel: a.perPixel, wrapAround: a.wrapAround, doubleSided: a.side === THREE.DoubleSide, flipSided: a.side === THREE.BackSide}, t, v, x, d = [];
            m ? d.push(m) : (d.push(q), d.push(s));
            for (v in r)d.push(v), d.push(r[v]);
            for (t in c)d.push(t), d.push(c[t]);
            m = d.join();
            t = 0;
            for (v = fa.length; t < v; t++)if (d = fa[t], d.code === m) {
                d.usedTimes++;
                k = d.program;
                break a
            }
            ...
            y = t;
            t = 0;
            for (v = y.length; t < v; t++)p = y[t], x.uniforms[p] = j.getUniformLocation(x, p);
            ...
            k = t;
            y = 0;
            for (b = k.length; y < b; y++)t = k[y], x.attributes[t] = j.getAttribLocation(x, t);
            x.id = Da++;
            fa.push({program: x, code: m, usedTimes: 1});
            M.info.memory.programs = fa.length;
            k = x
        }
        a.program = k;
    ...
    this.setTexture = function (a, b) {
        if (a.needsUpdate) {
            ...
            var c = a.image, d = 0 === (c.width & c.width - 1) && 0 === (c.height & c.height - 1), e = K(a.format),
                f = K(a.type);
            A(j.TEXTURE_2D, a, d);
            var g = a.mipmaps;
    ...
    this.setRenderTarget = function (a) {
        ...
        if (a && !a.__webglFramebuffer) {
            ...
            a.__webglTexture =
                j.createTexture();
            M.info.memory.textures++;
            var c = 0 === (a.width & a.width - 1) && 0 === (a.height & a.height - 1), d = K(a.format), e = K(a.type);
            if (b) {
...
THREE.GeometryUtils = {merge: function (a, b) {
    var c, d, e = a.vertices.length, f = b instanceof THREE.Mesh ? b.geometry : b, g = a.vertices, i = f.vertices, h = a.faces, k = f.faces, l = a.faceVertexUvs[0], f = f.faceVertexUvs[0];
    ...
    for (n = k.length; m < n; m++) {
        var r = k[m], p, q, s = r.vertexNormals, t = r.vertexColors;
        ...
        d && p.normal.applyMatrix3(d).normalize();
        g = 0;
        for (i = s.length; g < i; g++)q = s[g].clone(), d && q.applyMatrix3(d).normalize(), p.vertexNormals.push(q);
    ...
    var d, e, f, g = new THREE.Vector3, i = THREE.GeometryUtils.__v1;
    ...
    var d, e, f = a.faces, g = a.vertices, i = f.length, h = 0, k = [], l, m, n, r;
    ...
    for (c = a.faces.length; b < c; b++)if (d = a.faces[b], d instanceof THREE.Face4) {
        e = d.a;
        var h = d.b, k = d.c, l = d.d, m = new THREE.Face3, n = new THREE.Face3;
...
THREE.ImageUtils = {crossOrigin: "anonymous", loadTexture: function (a, b, c, d) {
    ...
    if (a instanceof Array)for (var g = 0, i = a.length; g < i; ++g) {
        var h = {};
        e[g] = h;
    ...
    var d = {mipmaps: [], width: 0, height: 0, format: null, mipmapCount: 1}, e = c("DXT1"), f = c("DXT3"), g = c("DXT5"), i = new Int32Array(a, 0, 31);
    ...
    for (var i = i[1] + 4, f = d.width, g = d.height, h = d.isCubemap ?
        ...
        for (var l = 0; l < d.mipmapCount; l++) {
            var m = Math.max(4, f) / 4 * Math.max(4, g) / 4 * e, n = {data: new Uint8Array(a, i, m), width: f, height: g};
            d.mipmaps.push(n);
            i += m;
            f = Math.max(0.5 * f, 1);
            g = Math.max(0.5 * g, 1)
    ...
    for (var i = g.getImageData(0,
        0, d, e).data, h = g.createImageData(d, e), k = h.data, l = 0; l < d; l++)for (var m = 0; m < e; m++) {
        var n = 0 > m - 1 ? 0 : m - 1, r = m + 1 > e - 1 ? e - 1 : m + 1, p = 0 > l - 1 ? 0 : l - 1, q = l + 1 > d - 1 ? d - 1 : l + 1, s = [], t = [0, 0, i[4 * (m * d + l)] / 255 * b];
        ...
        for (r = 0; r < p; r++) {
            var q = s[r], x = s[(r + 1) %
                p], q = [q[0] - t[0], q[1] - t[1], q[2] - t[2]], x = [x[0] - t[0], x[1] - t[1], x[2] - t[2]];
...
THREE.FontUtils = {faces: {}, face: "helvetiker", weight: "normal", style: "normal", size: 150, divisions: 10, getFace: function () {
    ...
    for (var b = this.getFace(), c = this.size / b.resolution, d =
        ...
        var i = new THREE.Path, i = this.extractGlyphPoints(e[a], b, c, d, i), d = d + i.offset;
        g.push(i.path)
    }
    return{paths: g, offset: d / 2}
}, extractGlyphPoints: function (a, b, c, d, e) {
    var f = [], g, i, h, k, l, m, n, r, p, q, s, t = b.glyphs[a] || b.glyphs["?"];
    if (t) {
        if (t.o) {
...
(function (a) {
    ...
    a.Triangulate = function (a, d) {
        ...
        for (k = e - 1; 2 < e;) {
            ...
            var n;
            a:{
                var r = n = void 0, p = void 0, q = void 0, s = void 0, t = void 0, x = void 0, z = void 0, v =
                    void 0, r = a[g[h]].x, p = a[g[h]].y, q = a[g[k]].x, s = a[g[k]].y, t = a[g[l]].x, x = a[g[l]].y;
                if (1E-10 > (q - r) * (x - p) - (s - p) * (t - r))n = !1; else {
                    var I = void 0, H = void 0, D = void 0, y = void 0, F = void 0, E = void 0, G = void 0, W = void 0, A = void 0, X = void 0, A = W = G = v = z = void 0, I = t - q, H = x - s, D = r - t, y = p - x, F = q - r, E = s - p;
                    for (n = 0; n < e; n++)if (!(n === h || n === k || n === l))if (z = a[g[n]].x, v = a[g[n]].y, G = z - r, W = v - p, A = z - q, X = v - s, z -= t, v -= x, A = I * X - H * A, G = F * W - E * G, W = D * v - y * z, 0 <= A && 0 <= W && 0 <= G) {
                        n = !1;
                        break a
                    }
                    n = !0
...
THREE.Curve.prototype.getUtoTmapping = function (a, b) {
    ...
    f = b ? b : a * c[e - 1];
    for (var g = 0, i = e - 1, h; g <= i;)if (d = Math.floor(g + (i - g) / 2), h = c[d] - f, 0 > h)g = d + 1; else if (0 < h)i = d - 1; else {
        i = d;
        break
    }
    d = i;
...
THREE.CurvePath.prototype.getWrapPoints = function (a, b) {
    var c = this.getBoundingBox(), d, e, f, g, i, h;
    d = 0;
    for (e = a.length; d < e; d++)f = a[d], g = f.x, i = f.y, h = g / c.maxX, h = b.getUtoTmapping(h, g), g = b.getPoint(h), i = b.getNormalVector(h).multiplyScalar(i), f.x = g.x + i.x, f.y = g.y + i.y;
    return a
};
...
THREE.Path.prototype.bezierCurveTo = function (a, b, c, d, e, f) {
    var g = Array.prototype.slice.call(arguments), i = this.actions[this.actions.length - 1].args, i = new THREE.CubicBezierCurve(new THREE.Vector2(i[i.length - 2], i[i.length - 1]), new THREE.Vector2(a, b), new THREE.Vector2(c, d), new THREE.Vector2(e, f));
    this.curves.push(i);
...
THREE.Path.prototype.absellipse = function (a, b, c, d, e, f, g) {
    var i = Array.prototype.slice.call(arguments), h = new THREE.EllipseCurve(a, b, c, d, e, f, g);
    this.curves.push(h);
    h = h.getPoint(g ? 1 : 0);
    i.push(h.x);
    i.push(h.y);
    this.actions.push({action: THREE.PathActions.ELLIPSE, args: i})
};
...
THREE.Path.prototype.getPoints = function (a, b) {
    ...
    var a = a || 12, c = [], d, e, f, g, i, h, k, l, m, n, r, p, q;
    d = 0;
...
THREE.Shape.Utils = {removeHoles: function (a, b) {
    var c = a.concat(), d = c.concat(), e, f, g, i, h, k, l, m, n, r, p = [];
    for (h = 0; h < b.length; h++) {
        ...
        p.push([k[g], c[i], c[e]]);
        p.push(f);
        c = m.concat(r).concat(l).concat(n)
    }
    return{shape: c,
        isolatedPts: p, allpoints: d}
}, triangulateShape: function (a, b) {
    var c = THREE.Shape.Utils.removeHoles(a, b), d = c.allpoints, e = c.isolatedPts, c = THREE.FontUtils.Triangulate(c.shape, !1), f, g, i, h, k = {};
    f = 0;
        ...
        if (!0 !== a.initialized) {
            for (var c = 0; c < a.hierarchy.length; c++) {
                ...
                if (a.hierarchy[c].keys.length && void 0 !== a.hierarchy[c].keys[0].morphTargets) {
                    i = {};
                    for (d = 0; d < a.hierarchy[c].keys.length; d++)for (var h = 0; h < a.hierarchy[c].keys[d].morphTargets.length; h++) {
                    ...
                    for (d = 0; d < a.hierarchy[c].keys.length; d++) {
                        var l = {};
                        for (k in i) {
                            for (h = 0; h < a.hierarchy[c].keys[d].morphTargets.length; h++)if (a.hierarchy[c].keys[d].morphTargets[h] === k) {
...
THREE.Animation.prototype.update = function (a) {
    if (!1 !== this.isPlaying) {
        var b = ["pos", "rot", "scl"], c, d, e, f, g, i, h, k, l;
        ...
        for (var m = 0, n = this.hierarchy.length; m < n; m++) {
            ...
            for (var r = 0; 3 > r; r++) {
                ...
                if ("pos" === c)if (c = a.position, this.interpolationType === THREE.AnimationHandler.LINEAR)c.x = e[0] + (f[0] - e[0]) * d, c.y = e[1] + (f[1] - e[1]) * d, c.z = e[2] +
                    (f[2] - e[2]) * d; else {
                    if (this.interpolationType === THREE.AnimationHandler.CATMULLROM || this.interpolationType === THREE.AnimationHandler.CATMULLROM_FORWARD)this.points[0] = this.getPrevKeyWith("pos", m, g.index - 1).pos, this.points[1] = e, this.points[2] = f, this.points[3] = this.getNextKeyWith("pos", m, i.index + 1).pos, d = 0.33 * d + 0.33, e = this.interpolateCatmullRom(this.points, d), c.x = e[0], c.y = e[1], c.z = e[2], this.interpolationType === THREE.AnimationHandler.CATMULLROM_FORWARD && (d = this.interpolateCatmullRom(this.points, 1.01 * d),
...
THREE.KeyFrameAnimation.prototype.update = function (a) {
    if (this.isPlaying) {
        var b, c, d, e, f = this.data.JIT.hierarchy, g, i, h;
                ...
                if (this.JITCompile && void 0 !== f[a][e])d instanceof THREE.Bone ? (d.skinMatrix = f[a][e], d.matrixWorldNeedsUpdate = !1) : (d.matrix = f[a][e], d.matrixWorldNeedsUpdate = !0); else if (l.length) {
                    ...
                    if (b && c) {
                        if (c.time <= i) {
                            ...
                            } else if (!h)for (var n = l.length - 1; c.time < g && c.index !== n;)b = c, c = l[b.index + 1];
                            m.prevKey = b;
                            m.nextKey = c
                        }
...
THREE.CubeGeometry = function (a, b, c, d, e, f) {
    function g(a, b, c, d, e, f, g, q) {
        var s, t = i.widthSegments, x = i.heightSegments, z = e / 2, v = f / 2, I = i.vertices.length;
        if ("x" === a && "y" === b || "y" === a && "x" === b)s = "z"; else if ("x" === a && "z" === b || "z" === a && "x" === b)s = "y", x = i.depthSegments; else if ("z" === a && "y" === b || "y" === a && "z" === b)s = "x", t = i.depthSegments;
        var H = t + 1, D = x + 1, y = e / t, F = f / x, E = new THREE.Vector3;
        E[s] = 0 < g ? 1 : -1;
        for (e = 0; e < D; e++)for (f = 0; f < H; f++) {
...
THREE.CylinderGeometry = function (a, b, c, d, e, f) {
    THREE.Geometry.call(this);
    var a = void 0 !== a ? a : 20, b = void 0 !== b ? b : 20, c = void 0 !== c ? c : 100, g = c / 2, d = d || 8, e = e || 1, i, h, k = [], l = [];
    for (h = 0; h <= e; h++) {
        var m = [], n = [], r = h / e, p = r * (b - a) + a;
        for (i = 0; i <= d; i++) {
            var q = i / d, s = new THREE.Vector3;
    ...
    for (i = 0; i < d; i++) {
        ...
        for (h = 0; h < e; h++) {
            var r = k[h][i], p = k[h + 1][i], q = k[h + 1][i + 1], s = k[h][i + 1], t = m.clone(), x = m.clone(), z = n.clone(), v = n.clone(), I = l[h][i].clone(), H = l[h + 1][i].clone(), D = l[h + 1][i + 1].clone(), y = l[h][i + 1].clone();
...
THREE.ExtrudeGeometry.prototype.addShape = function (a, b) {
    ...
    function e(c, d) {
        ...
        for (J = c.length; 0 <= --J;) {
            ...
            for (var g = 0, h = r + 2 * l,
                     g = 0; g < h; g++) {
                var i = aa * g, k = aa * (g + 1), m = d + e + i, i = d + f + i, n = d + f + k, k = d + e + k, p = c, q = g, s = h, t = e, v = f, m = m + W, i = i + W, n = n + W, k = k + W;
    ...
    var i = void 0 !== b.amount ? b.amount :
        100, h = void 0 !== b.bevelThickness ? b.bevelThickness : 6, k = void 0 !== b.bevelSize ? b.bevelSize : h - 2, l = void 0 !== b.bevelSegments ? b.bevelSegments : 3, m = void 0 !== b.bevelEnabled ? b.bevelEnabled : !0, n = void 0 !== b.curveSegments ? b.curveSegments : 12, r = void 0 !== b.steps ? b.steps : 1, p = b.extrudePath, q, s = !1, t = b.material, x = b.extrudeMaterial, z = void 0 !== b.UVGenerator ? b.UVGenerator : THREE.ExtrudeGeometry.WorldUVGenerator, v, I, H, D;
    ...
    m || (k = h = l = 0);
    var y, F, E, G = this, W = this.vertices.length, n = a.extractPoints(n), A = n.shape, n = n.holes;
    ...
    var X = THREE.Shape.Utils.triangulateShape(A, n), p = A;
    F = 0;
    for (E = n.length; F < E; F++)y = n[F], A = A.concat(y);
    var B, K, L, U, aa = A.length, ba = X.length, xa = [], J = 0, ha = p.length;
    B = ha - 1;
    for (K = J + 1; J < ha; J++, B++, K++)B === ha &&
        (B = 0), K === ha && (K = 0), xa[J] = d(p[J], p[B], p[K]);
    var ua = [], Oa, M = xa.concat();
    F = 0;
    ...
    for (J = 0; J < aa; J++)U = m ? c(A[J], M[J],
        K) : A[J], s ? (H.copy(v.normals[0]).multiplyScalar(U.x), I.copy(v.binormals[0]).multiplyScalar(U.y), D.copy(q[0]).add(H).add(I), f(D.x, D.y, D.z)) : f(U.x, U.y, 0);
    for (y = 1; y <= r; y++)for (J = 0; J < aa; J++)U = m ? c(A[J], M[J], K) : A[J], s ? (H.copy(v.normals[y]).multiplyScalar(U.x), I.copy(v.binormals[y]).multiplyScalar(U.y), D.copy(q[y]).add(H).add(I), f(D.x, D.y, D.z)) : f(U.x, U.y, i / r * y);
    for (B = l - 1; 0 <= B; B--) {
        y = B / l;
        L = h * (1 - y);
        K = k * Math.sin(y * Math.PI / 2);
...
THREE.ExtrudeGeometry.WorldUVGenerator = {generateTopUV: function (a, b, c, d, e, f) {
    ...
    var b = a.vertices[e].x, c = a.vertices[e].y, e = a.vertices[e].z, d = a.vertices[f].x, h = a.vertices[f].y, f = a.vertices[f].z, k = a.vertices[g].x,
        l = a.vertices[g].y, g = a.vertices[g].z, m = a.vertices[i].x, n = a.vertices[i].y, a = a.vertices[i].z;
...
THREE.ShapeGeometry.prototype.addShape = function (a, b) {
    void 0 === b && (b = {});
    var c = b.material, d = void 0 === b.UVGenerator ? THREE.ExtrudeGeometry.WorldUVGenerator : b.UVGenerator, e, f, g, i = this.vertices.length;
    e = a.extractPoints(void 0 !== b.curveSegments ? b.curveSegments : 12);
    var h = e.shape, k = e.holes;
...
THREE.LatheGeometry = function (a, b, c, d) {
    THREE.Geometry.call(this);
    for (var b = b || 12, c = c || 0, d = d || 2 * Math.PI, e = 1 / (a.length - 1), f = 1 / b, g = 0, i = b; g <= i; g++)for (var h = c + g * f * d, k = Math.cos(h), l = Math.sin(h), h = 0, m = a.length; h < m; h++) {
        var n = a[h], r = new THREE.Vector3;
        r.x = k * n.x - l * n.y;
        r.y = l * n.x + k * n.y;
        r.z = n.z;
...
THREE.PlaneGeometry = function (a, b, c, d) {
    ...
    for (var c = a / 2, e = b / 2, d = this.widthSegments, f = this.heightSegments, g = d + 1, i = f + 1, h = this.width / d, k = this.height / f, l = new THREE.Vector3(0, 0, 1), a = 0; a < i; a++)for (b = 0; b < g; b++)this.vertices.push(new THREE.Vector3(b * h - c, -(a * k - e), 0));
...
THREE.SphereGeometry = function (a, b, c, d, e, f, g) {
    ...
    for (var d = void 0 !== d ? d : 0, e = void 0 !== e ? e : 2 * Math.PI, f = void 0 !== f ? f : 0, g = void 0 !== g ? g : Math.PI, i = [], h = [], c = 0; c <= this.heightSegments; c++) {
        for (var k = [], l = [], b = 0; b <= this.widthSegments; b++) {
            var m = b / this.widthSegments, n = c / this.heightSegments, r = new THREE.Vector3;
    ...
    for (c = 0; c < this.heightSegments; c++)for (b = 0; b < this.widthSegments; b++) {
        var d = i[c][b + 1], e = i[c][b], f = i[c + 1][b], g = i[c + 1][b + 1], k = this.vertices[d].clone().normalize(), l = this.vertices[e].clone().normalize(), m = this.vertices[f].clone().normalize(), n = this.vertices[g].clone().normalize(), r = h[c][b + 1].clone(), p = h[c][b].clone(), q = h[c + 1][b].clone(),
            s = h[c + 1][b + 1].clone();
...
THREE.TorusGeometry = function (a, b, c, d, e) {
    ...
    for (c = 0; c <= this.radialSegments; c++)for (d = 0; d <= this.tubularSegments; d++) {
        ...
        b.push(i.clone().sub(e).normalize())
    }
    for (c = 1; c <= this.radialSegments; c++)for (d = 1; d <= this.tubularSegments; d++) {
        var e = (this.tubularSegments + 1) * c + d - 1, f = (this.tubularSegments + 1) * (c - 1) + d - 1, g = (this.tubularSegments + 1) * (c - 1) + d, i = (this.tubularSegments + 1) * c + d, h = new THREE.Face4(e, f, g, i, [b[e], b[f], b[g], b[i]]);
        h.normal.add(b[e]);
        h.normal.add(b[f]);
        h.normal.add(b[g]);
        h.normal.add(b[i]);
...
THREE.TorusKnotGeometry = function (a, b, c, d, e, f, g) {
    ...
    for (a = 0; a < this.radialSegments; ++a) {
        ...
        for (b = 0; b < this.tubularSegments; ++b) {
            var h = 2 * (a / this.radialSegments) * this.p * Math.PI, g = 2 * (b / this.tubularSegments) * Math.PI, f = i(h, g, this.q, this.p, this.radius, this.heightScale), h = i(h + 0.01, g, this.q, this.p, this.radius, this.heightScale);
            c.subVectors(h, f);
            d.addVectors(h, f);
            e.crossVectors(c, d);
            d.crossVectors(e, c);
...
THREE.TubeGeometry = function (a, b, c, d, e, f) {
    ...
    this.grid = [];
    var g, i, e = this.segments + 1, h, k, l, f = new THREE.Vector3, m, n, r, b = new THREE.TubeGeometry.FrenetFrames(this.path, this.segments, this.closed);
    m = b.tangents;
    n = b.normals;
    r = b.binormals;
    this.tangents = m;
...
THREE.TubeGeometry.FrenetFrames = function (a, b, c) {
    ...
    new THREE.Vector3;
    var e = [], f = [], g = [], i = new THREE.Vector3, h = new THREE.Matrix4, b = b + 1, k, l, m;
    this.tangents = e;
    this.normals = f;
    this.binormals = g;
...
THREE.PolyhedronGeometry = function (a, b, c, d) {
    ...
    function f(a, b, c, d) {
        1 > d ? (d = new THREE.Face3(a.index, b.index, c.index, [a.clone(), b.clone(), c.clone()]), d.centroid.add(a).add(b).add(c).divideScalar(3), d.normal = d.centroid.clone().normalize(), h.faces.push(d), d = Math.atan2(d.centroid.z, -d.centroid.x), h.faceVertexUvs[0].push([i(a.uv,
...
THREE.ParametricGeometry = function (a, b, c, d) {
    THREE.Geometry.call(this);
    var e = this.vertices, f = this.faces, g = this.faceVertexUvs[0], d = void 0 === d ? !1 : d, i, h, k, l, m = b + 1;
    for (i = 0; i <= c; i++) {
        l = i / c;
        for (h = 0; h <= b; h++)k = h / b, k = a(k, l), e.push(k)
    }
    var n, r, p, q;
    for (i = 0; i < c; i++)for (h = 0; h < b; h++)a = i * m + h, e = i * m + h + 1, l = (i + 1) * m + h, k = (i + 1) * m + h + 1, n = new THREE.Vector2(h / b, i / c), r = new THREE.Vector2((h + 1) / b, i / c), p = new THREE.Vector2(h / b, (i + 1) / c), q = new THREE.Vector2((h + 1) / b, (i + 1) / c), d ? (f.push(new THREE.Face3(a, e, l)), f.push(new THREE.Face3(e,
...
THREE.ConvexGeometry = function (a) {
    ...
    for (var c = [
        ...
        for (var g = [], i = 0; i < c.length;) {
            var h = c[i], k = f, l = a[h[0]], m;
            m = l;
            var n = a[h[1]], r = a[h[2]], p = new THREE.Vector3, q = new THREE.Vector3;
            p.subVectors(r, n);
            q.subVectors(m, n);
            p.cross(q);
            p.normalize();
...
THREE.DirectionalLightHelper = function (a, b) {
    ...
    var c = this.color.getHex(), d = new THREE.SphereGeometry(b, 16, 8), e = new THREE.AsteriskGeometry(1.25 * b, 2.25 * b), f = new THREE.MeshBasicMaterial({color: c, fog: !1}), g = new THREE.LineBasicMaterial({color: c, fog: !1});
    this.lightSphere =
        new THREE.Mesh(d, f);
...
THREE.HemisphereLightHelper = function (a, b, c) {
    ...
    for (var d = this.groundColor.getHex(), f = new THREE.SphereGeometry(b, 16, 8, 0, 2 * Math.PI, 0, 0.5 * Math.PI), g = new THREE.SphereGeometry(b, 16, 8, 0, 2 * Math.PI, 0.5 * Math.PI, Math.PI), i = new THREE.MeshBasicMaterial({color: e,
        fog: !1}), h = new THREE.MeshBasicMaterial({color: d, fog: !1}), k = 0, l = f.faces.length; k < l; k++)f.faces[k].materialIndex = 0;
    k = 0;
...
THREE.PointLightHelper = function (a, b) {
    ...
    this.color = a.color.clone();
    this.color.multiplyScalar(c);
    var d = this.color.getHex(), c = new THREE.SphereGeometry(b, 16, 8), e = new THREE.AsteriskGeometry(1.25 * b, 2.25 * b), f = new THREE.IcosahedronGeometry(1, 2), g = new THREE.MeshBasicMaterial({color: d, fog: !1}), i = new THREE.LineBasicMaterial({color: d, fog: !1}), d = new THREE.MeshBasicMaterial({color: d, fog: !1, wireframe: !0, opacity: 0.1,
        transparent: !0});
...
THREE.SpotLightHelper = function (a, b) {
    ...
    this.color = a.color.clone();
    this.color.multiplyScalar(c);
    var c = this.color.getHex(), d = new THREE.SphereGeometry(b, 16, 8), e = new THREE.AsteriskGeometry(1.25 * b, 2.25 * b), f = new THREE.CylinderGeometry(1E-4, 1, 1, 8, 1, !0), g = new THREE.Matrix4;
    g.rotateX(-Math.PI / 2);
    g.translate(new THREE.Vector3(0,
        -0.5, 0));
    f.applyMatrix(g);
    var i = new THREE.MeshBasicMaterial({color: c, fog: !1}), g = new THREE.LineBasicMaterial({color: c, fog: !1}), h = new THREE.MeshBasicMaterial({color: c, fog: !1, wireframe: !0, opacity: 0.3, transparent: !0});
    ...
    this.lightSphere.properties.gizmoRoot = this;
    this.targetSphere = null;
    void 0 !== a.target.properties.targetInverse && (e = new THREE.SphereGeometry(b, 8, 4), g = new THREE.MeshBasicMaterial({color: c, wireframe: !0, fog: !1}), this.targetSphere = new THREE.Mesh(e, g), this.targetSphere.position = a.target.position, this.targetSphere.properties.isGizmo = !0, this.targetSphere.properties.gizmoSubject =
        a.target, this.targetSphere.properties.gizmoRoot = this.targetSphere, c = new THREE.LineDashedMaterial({color: c, dashSize: 4, gapSize: 4, opacity: 0.75, transparent: !0, fog: !1}), e = new THREE.Geometry, e.vertices.push(this.position.clone()), e.vertices.push(this.targetSphere.position.clone()), e.computeLineDistances(), this.targetLine = new THREE.Line(e, c), this.targetLine.properties.isGizmo = !0);
    this.properties.isGizmo = !0
};
...
THREE.LensFlarePlugin = function () {
    ...
    this.render = function (a, d, e, f) {
        var a = a.__webglFlares, x = a.length;
        if (x) {
            var z = new THREE.Vector3, v = f / e, I = 0.5 * e, H = 0.5 * f, D = 16 / f, y = new THREE.Vector2(D * v, D), F = new THREE.Vector3(1, 1, 0), E = new THREE.Vector2(1, 1), G = r, D = n;
            b.useProgram(m);
            ...
            b.depthMask(!1);
            var W, A, X, B, K;
            for (W = 0; W < x; W++)if (D = 16 / f, y.set(D * v, D), B = a[W], z.set(B.matrixWorld.elements[12], B.matrixWorld.elements[13], B.matrixWorld.elements[14]), z.applyMatrix4(d.matrixWorldInverse), z.applyProjection(d.projectionMatrix), F.copy(z), E.x = F.x * I + I,
...
THREE.ShadowMapPlugin = function () {
    var a, b, c, d, e, f, g = new THREE.Frustum, i = new THREE.Matrix4, h = new THREE.Vector3, k = new THREE.Vector3;
    ...
    this.update = function (l, m) {
        ...
        b.setDepthTest(!0);
        n = 0;
        for (r = l.__lights.length; n < r; n++)if (p = l.__lights[n], p.castShadow)if (p instanceof THREE.DirectionalLight && p.shadowCascade)for (s = 0; s < p.shadowCascadeCount; s++) {
            var H;
            if (p.shadowCascadeArray[s])H = p.shadowCascadeArray[s]; else {
                v = p;
                x = s;
        ...
        for (r = I.length; n < r; n++) {
            p = I[n];
            p.shadowMap || (s = THREE.LinearFilter, b.shadowMapType === THREE.PCFSoftShadowMap && (s = THREE.NearestFilter), p.shadowMap = new THREE.WebGLRenderTarget(p.shadowMapWidth, p.shadowMapHeight, {minFilter: s, magFilter: s, format: THREE.RGBAFormat}), p.shadowMapSize = new THREE.Vector2(p.shadowMapWidth, p.shadowMapHeight), p.shadowMatrix = new THREE.Matrix4);
            if (!p.shadowCamera) {
            ...
            v = l.__webglObjects;
            p = 0;
            for (q = v.length; p < q; p++)if (x = v[p], t = x.object, x.render = !1, t.visible && t.castShadow && (!(t instanceof THREE.Mesh || t instanceof THREE.ParticleSystem) || !t.frustumCulled || g.intersectsObject(t)))t._modelViewMatrix.multiplyMatrices(s.matrixWorldInverse, t.matrixWorld), x.render = !0;
            p = 0;
...
THREE.SpritePlugin = function () {
    ...
    this.init = function (a) {
        ...
        b.bindBuffer(b.ELEMENT_ARRAY_BUFFER, i);
        b.bufferData(b.ELEMENT_ARRAY_BUFFER, f, b.STATIC_DRAW);
        var a = THREE.ShaderSprite.sprite, n = b.createProgram(), r = b.createShader(b.FRAGMENT_SHADER), p = b.createShader(b.VERTEX_SHADER), q = "precision " + d + " float;\n";
    ...
    this.render = function (d, e, f, p) {
        var q = d.__webglSprites, s = q.length;
        if (s) {
            var t = k, x = l, z = p /
                f, f = 0.5 * f, v = 0.5 * p;
            b.useProgram(h);
...
THREE.DepthPassPlugin = function () {
    ...
    var a, b, c, d, e, f, g = new THREE.Frustum, i = new THREE.Matrix4;
    this.init = function (g) {
        a = g.context;
        b = g;
        ...
        d = new THREE.ShaderMaterial({fragmentShader: g.fragmentShader, vertexShader: g.vertexShader, uniforms: i, morphTargets: !0});
        e = new THREE.ShaderMaterial({fragmentShader: g.fragmentShader,
            vertexShader: g.vertexShader, uniforms: i, skinning: !0});
        f = new THREE.ShaderMaterial({fragmentShader: g.fragmentShader, vertexShader: g.vertexShader, uniforms: i, morphTargets: !0, skinning: !0});
        c._shadowPass = !0;
        d._shadowPass = !0;
        e._shadowPass = !0;
        f._shadowPass = !0
    ...
    this.update = function (h, k) {
        ...
        q = h.__webglObjects;
        l = 0;
        for (m = q.length; l < m; l++)if (n = q[l], p = n.object, n.render = !1, p.visible && (!(p instanceof THREE.Mesh || p instanceof THREE.ParticleSystem) || !p.frustumCulled || g.intersectsObject(p)))p._modelViewMatrix.multiplyMatrices(k.matrixWorldInverse, p.matrixWorld), n.render = !0;
        var s;
        l = 0;
        for (m = q.length; l < m; l++)if (n = q[l], n.render && (p = n.object, n = n.buffer, !(p instanceof THREE.ParticleSystem) || p.customDepthMaterial))(s =
